 ...
 *#######################################################################*/
    ...
    { {17,3,3,3,3},
      {     "SLOPE MEASUREMENT",	// English 
            ...
            "BAR",      // German 
            "NOO",      // Italian
            "medición de inclinación"      // Spanish
		} }, 
 ...
 *#######################################################################*/	
	...
	{ {19,3,3,3,3},
      {     "COMPASS CALIBRATION",  // English 
		    ...
		    "BAR",      			// German 
		    "NOO",      			// Italian
		    "calibración de la brújula"      			// Spanish
	} },
 ...
 *#######################################################################*/ 
	...
	{ {16,3,3,3,3},
      {     "ARE YOU SURE YOU",  // English 
		    ...
		    "BAR",      			// German 
		    "NOO",      			// Italian
		    "Seguramente (depends on context)"      			// Spanish
	} },
  ...
  /*  str_READING_RECORD */
	{ {14,3,3,3,3},
      {     "READING RECORD",  // English 
		    ...
		    "BAR",      			// German 
		    "NOO",      			// Italian
		    "leyendo récord (don't know if this actually works)"      			// Spanish
	} },
  ...
  /*  str_LINK */
	{ {4,3,3,3,3},
      {     "LINK",  // English 
		    ...
		    "BAR",      			// German 
		    "NOO",      			// Italian
		    "enlazar (google translate)"      			// Spanish
	} },
  ...
  /*  str_LINK_SNOW_PROFILE */
	{ {17,3,3,3,3},
      {     "LINK SNOW PROFILE",  // English 
		    ...
		    "BAR",      			// German 
		    "NOO",      			// Italian
		    "enlazar perfíl de nieve"      			// Spanish
	} },
  ...
  /*  str_ENTER_PASSWORD */
	...
	{ {16,3,3,3,3},
      {		"DAILY TEST LIMIT",	// English 
    		...
    		"BAR",      // German 
    		"NOO",      // Italian 
    		"límite de pruebas diaria"      // Spanish
    } },
 ...
 *#######################################################################*/ 
    ...
    { {12,3,3,3,3},
      {     "ABOUT DEVICE",	    // English 
            ...
            "BAR",      				// German 
            "NOO",      				// Italian
            "Información del aparato"      				// Spanish
		} }, 
 ...
 *#######################################################################*/
    ...
    { {4,3,3,3,3},
      {     "EYE:",	    // English 
            ...
            "BAR",      // German 
            "NOO",      // Italian
            "Ojo (not sure this is what you mean)"      // Spanish
		} }, 
